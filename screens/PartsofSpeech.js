        ...
        <View style={styles.container}>
            ...
            <ImageBackground
                ...
                <View  style={styles.titlebox}>
                    <Text style={styles.dashtitle}>Parts of Speech</Text>
                </View>
                
                <View style={styles.Content}>
                    <View style={styles.lessonsbox}>  
                        <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>I. What are Parts of Speech?</Text>
                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>II. Examples of Parts of Speech</Text>

                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>III. The Importance of Parts of Speech</Text>
