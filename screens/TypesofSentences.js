...
export default function TypesofSentences() {
        ...
        <View style={styles.container}>
            ...
            <ImageBackground
                ...
                <View  style={styles.titlebox}>
                    <Text style={styles.dashtitle}>Types of Sentences</Text>
                </View>
                
                <View style={styles.Content}>
                    <View style={styles.lessonsbox}>  
                        <View style={[styles.lessons, {paddingTop: 35}]}>
                        <Text style={styles.lesstitle}>I. What is Sentence?</Text>
                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>II. What are the Types of Sentences</Text>

                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>III. The History of Sentences</Text>
