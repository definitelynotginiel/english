...
export default function FiguresofSpeech() {
                ...
                <View style={styles.Content}>
                    <View style={styles.lessonsbox}>  
                        <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>I. What are Figures of Speech?</Text>
                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>II. Examples of Figure of Speech</Text>
