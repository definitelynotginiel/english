...
export default function KindsofGrammar() {
        ...
        <View style={styles.container}>
            ...
            <ImageBackground
                ...
                <View  style={styles.titlebox}>
                    <Text style={styles.dashtitle}>Kinds of Grammar</Text>
                </View>
                
                <View style={styles.Content}>
                    <View style={styles.lessonsbox}>  
                        <View style={[styles.lessons, {paddingTop: 35}]}>
                        <Text style={styles.lesstitle}>I. What is Grammar?</Text>
                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>II. What are the Kinds of Grammar</Text>

                            </View>
                            <View style={styles.lessons}>
                            <Text style={styles.lesstitle}>III. The History of Grammar</Text>
